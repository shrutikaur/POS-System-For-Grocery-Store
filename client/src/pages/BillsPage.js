...
const BillsPage = () => {
  ...
  const getAllBills = async () => {
    try {
      ...
      const sortedData = data.sort((a, b) => new Date(b.date) - new Date(a.date)); // Sort bills by date in descending order
        ...
        >
          ...
          <div id="invoice-POS" ref={componentRef}>
            <center id="top">
              <div className="logo" />
              <div className="info">
                <h2>POS System By Manpreet</h2>
                <p> Contact : 123456 | Nanded Maharashtra</p>
              </div>
              {/*End Info*/}
            </center>
            {/*End InvoiceTop*/}
            ...
            <div id="bot">
              ...
              <div id="legalcopy">
                <p className="legal">
                  <strong>Thank you for your order!</strong> 12% GST application
                  on total amount.Please note that this is non refundable amount.
                  For any assistance,please write an email
